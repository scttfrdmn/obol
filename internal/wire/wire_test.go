...
func TestRoundTrip(t *testing.T) {
	cases := []struct {
		...
		{"bind-array-task", BindFrame(&BindRequest{Token: "budget:abc123", JobID: "4711_3", IsArrayTask: true, Idx: 3})},
		...
		{"settle-array-task", SettleFrame(&SettleRequest{JobID: "4711_3", Kind: SettleComplete, Runtime: 1800, IsArrayTask: true, Idx: 3})},

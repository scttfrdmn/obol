...
func Run(args []string, out, errOut io.Writer) int {
	...
	case "reconcile":
		return cmdReconcile(rest, out, errOut)
	case "create":
...
Usage:
  ...
  obol gate    (--account A | --source A --source B ...) --partition P --time-limit S [--ntasks N] [--cpus N] [--gpus N] [--mem MB] [--uid U]
  ...
  obol reconcile [jobid...]              reclaim orphaned escrows (live ids from args or stdin; admin)

...
- **Go 1.26** (`go` directive `1.26`); CI also runs the previous supported major (1.25). Do not
  use language features newer than the floor without bumping it deliberately.
